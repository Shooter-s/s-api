...
import com.shooter.sapibackend.mapper.UserMapper;
...
import static com.shooter.sapibackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public List<UserVO> getUserVO(List<User> userList) {
        ...
        return userList.stream().map(item -> getUserVO(item)).collect(Collectors.toList());
    }
